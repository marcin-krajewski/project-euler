package pl.krajewski.euler.problems.poker;

import java.util.List;

import pl.krajewski.euler.problems.poker.Card.Type;

public class PokerHand implements Comparable<PokerHand> {

	private Poker poker;
	private PokerHandType type;
	private List<Type> descOrderedTypes;
	...
	private void setTypeForPoker(Poker poker) {
		...
		Type maxTypeCard = poker.getMaxType();
	...
	public List<Type> getDescOrderedTypes() {
