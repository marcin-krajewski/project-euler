package pl.com.simbit.euler.problems.implementations.problems201_210;
...
public class Problem210 extends Problem<String> {
	...
	public String resolveProblem() {
		...
		resultOfProductAndSum = StringAsNum.sumStringNumbers(
				new String[] { resultOfProductFirstRange, resultOfProductAndSum, format(rdiv2minus2) });
