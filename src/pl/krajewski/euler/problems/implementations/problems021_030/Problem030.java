...
public class Problem030 extends Problem<Double> {
    ...
    public Double resolveProblem() {
        ...
        double sumOfNumbers = checkNumbersForLevelAndOtherValues(
            level, 0, mapWithPowers, values, new ArrayList<Integer>());
        
        return sumOfNumbers;
    }
    
    private double checkNumbersForLevelAndOtherValues(
        int level, int prevSum, Map<Integer, Integer> mapWithPowers, 
        ...
        for(int digit=0; digit<=9; digit++) {
            ...
            returnValue += checkNumbersForLevelAndOtherValues(
                level-1, newSum, mapWithPowers, values, tabWithDigits);
        }
        return returnValue;
    }
